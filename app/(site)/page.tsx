            ...
            <div className="hero-sticky">
                ...
                <div ref={el => { textRefs.current[0] = el; }} className="hero-text-overlay text-first">
                    <div className="hero-accent-line">
                        ...
                        <span className="accent-label">The 18 Label</span>
                    </div>
                ...
                <div ref={el => { textRefs.current[7] = el; }} className="hero-text-overlay text-last">
                    ...
                    <p className="hero-desc" style={{ color: "#ffffff" }}>Embrace the style that defines you.</p>
                    <a href="#" className="hero-cta-pill">Explore Ethnic Wear</a>
                </div>
            ...
            <div className="w-full flex justify-center px-0 sm:px-6 lg:px-8">
                <div className="w-full max-w-7xl">
                    ...
                    <div className="category-grid" style={{ paddingLeft: '1rem', paddingRight: '1rem' }}>
                        {[
                            { title: "Signature Saree", img: "/sequence1/ezgif-frame-050.jpg", floatClass: "float-v2 delay-1" },
                            { title: "Classic Lehenga", img: "/sequence2/ezgif-frame-050.jpg", floatClass: "float-diag delay-2" },
                            { title: "Evening Kurti", img: "/sequence1/ezgif-frame-150.jpg", floatClass: "float-breathe delay-3" }
                        ].map((product, i) => (
                            <a href="#" key={i} className="category-card hover-float-parent">
                                <div className="category-card-image">
                                    <img src={product.img} alt={product.title} loading="lazy" className={`floating-img ${product.floatClass}`} />
                                    ...
                                    <div className="category-card-label" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', width: '100%', left: 0, right: 0 }}>
                                        <h3 style={{ textAlign: 'center', margin: 0, width: '100%' }}>{product.title}</h3>
        ...
        <section id="hero2" ref={scrollSectionRef2} className="hero-section" style={{ height: "1800vh" }}>
            <div className="hero-sticky">
                ...
                <div ref={el => { textRefs2.current[9] = el; }} className="hero-text-overlay text-last">
                    ...
                    <p className="hero-desc" style={{ color: "#ffffff" }}>Embrace the jewelry that defines you.</p>
                    <a href="#" className="hero-cta-pill">Explore Jewelry</a>
                </div>
        ...
        <section className="bg-black relative z-10" style={{ paddingTop: "6rem", paddingBottom: "8rem" }}>
            <div className="w-full flex justify-center px-0 sm:px-6 lg:px-8">
                <div className="w-full max-w-7xl">
                    ...
                    <div className="category-grid" style={{ paddingLeft: '1rem', paddingRight: '1rem' }}>
                        {[
                            { title: "18k Solid Link", img: "/sequence3/ezgif-frame-050.jpg", floatClass: "float-drift delay-1" },
                            { title: "Radiant Solitaire", img: "/sequence4/ezgif-frame-050.jpg", floatClass: "float-v1 delay-2" },
                            { title: "Eternity Band", img: "/sequence3/ezgif-frame-150.jpg", floatClass: "float-breathe delay-3" }
                        ].map((product, i) => (
                            <a href="#" key={i} className="category-card hover-float-parent">
                                <div className="category-card-image">
                                    <img src={product.img} alt={product.title} loading="lazy" className={`floating-img ${product.floatClass}`} />
