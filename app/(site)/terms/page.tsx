      ...
      <section className="relative w-full h-[40vh] min-h-[300px] flex items-center justify-center overflow-hidden border-b border-[#1A1A1A]/10">
        ...
        <div className="relative z-10 text-center flex flex-col items-center px-4 mt-12">
          ...
          <h1 className="font-normal text-4xl md:text-6xl text-[#1A1A1A] tracking-widest uppercase" style={{ fontFamily: '"Times New Roman", Times, serif' }}>
            Terms & <span className="text-[#9c7d23] italic font-normal tracking-normal lowercase" style={{ fontFamily: '"Times New Roman", Times, serif' }}>Conditions</span>
          </h1>
        </div>
      </section>
        ...
        <div className="w-full max-w-4xl font-outfit font-light text-[#1A1A1A]/70 leading-[2.2] tracking-wide text-sm md:text-base space-y-16">
          ...
          <div className="prose max-w-none">
            <p className="text-xl md:text-2xl italic text-[#1A1A1A]/90 leading-relaxed text-center mb-16" style={{ fontFamily: '"Times New Roman", Times, serif' }}>
              &ldquo;By accessing, browsing, or purchasing from The 18 Label website, you agree to these Terms &amp; Conditions. We strive to provide an impeccable experience.&rdquo;
            </p>
          </div>
          ...
          {[
            {
              title: "General",
              content: "The 18 Label reserves the right to modify or update these terms when required. Any revised terms will be applicable once published on the website."
            },
            {
              title: "Products",
            ...
            },
            {
              ...
              content: "All content appearing on The 18 Label website—including the brand name, logo, photographs, product images, videos, graphics, designs and written content—is the property of The 18 Label or its respective licensors. Unauthorised copying, reproduction, commercial use or distribution is prohibited."
            },
            {
              title: "Governing Law",
